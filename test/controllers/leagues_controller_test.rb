...
class LeaguesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create league" do
    assert_difference("League.count") do
      post leagues_url, params: { league: { api_football_id: @league.api_football_id, country_id: @league.country_id, name: @league.name } }
    end
  ...
  test "should update league" do
    patch league_url(@league), params: { league: { api_football_id: @league.api_football_id, country_id: @league.country_id, name: @league.name } }
