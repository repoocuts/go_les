...
class AppearanceDashboard < Administrate::BaseDashboard
	...
	# Overwrite this method to customize how appearances are displayed
	# across all pages of the ceefax dashboard.
	#
	def display_resource(appearance)
		"#{appearance.appearance_player_name}"
	end
end
